...
<div class="x_panel">
    ...
    {!! Form::open(['url' => route('renterAdd'),'class'=>'form-horizontal','method'=>'POST','id'=>'new_form']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('area',old('area'),['class' => 'form-control','placeholder'=>'Укажите локацию','maxlength'=>'50','required'=>'required'])!!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('agent',old('agent'),['class' => 'form-control','placeholder'=>'Укажите контактное лицо','maxlength'=>'70','required'=>'required'])!!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::email('email',old('email'),['class' => 'form-control','placeholder'=>'Укажите E-Mail','maxlength'=>'70'])!!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::select('status',['1' => 'Действующая', '0' => 'Не действующая'], old('status'), ['class' => 'form-control','required'=>'required']); !!}
        </div>
    </div>
