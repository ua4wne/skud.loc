...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            @if($rows)
                <div class="x_content">
                    <a href="{{route('evlogDel')}}">
                        <button type="button" class="btn btn-default btn-sm" id="clear_btn"><i class="fa fa-trash-o red"
                                                                                aria-hidden="true"></i> Очистить лог
                        </button>
                    </a>
                    <a href="{{route('tracelogs')}}">
                        <button type="button" class="btn btn-default btn-sm" id="clear_btn"><i class="fa fa-commenting-o green"
                                                                                               aria-hidden="true"></i> Лог трассировки
                        </button>
                    </a>
                </div>
                <div class="x_panel">
                    <table id="mytable" class="table table-striped table-bordered">
                        ...
                        @foreach($rows as $row)
                            ...
                            <tr id="{{ $row->id }}">
                                ...
                                <td style="width:70px;">
                                    {!! Form::open(['url'=>route('evlogDelOne',['id'=>$row->id]), 'class'=>'form-horizontal','method' => 'GET']) !!}
