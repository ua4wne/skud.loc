...
<div class="x_panel">
    ...
    {!! Form::open(['url' => route('dtypeAdd'),'class'=>'form-horizontal','method'=>'POST','id'=>'new_form']) !!}
    ...
    <div class="form-group">
        ...
        <div class="col-xs-8">
            {!! Form::text('text',old('text'),['class' => 'form-control','placeholder'=>'Введите вид документа','maxlength'=>'50','required'=>'required'])!!}
