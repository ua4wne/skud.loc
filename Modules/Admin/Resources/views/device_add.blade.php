...
@section('content')
    ...
    <ul class="breadcrumb">
        ...
        <li><a href="{{ route('cards') }}">{{$title}}</a></li>
    ...
    <div class="x_panel">
        ...
        {!! Form::open(['url' => route('deviceAdd'),'class'=>'form-horizontal','method'=>'POST','id'=>'new_form','files'=>'true']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('type',old('type'),['class' => 'form-control','placeholder'=>'Введите тип устройства','maxlength'=>'10','required'=>'required'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('snum',old('snum'),['class' => 'form-control','placeholder'=>'Введите серийный номер устройства','maxlength'=>'10','required'=>'required'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('fware',old('fware'),['class' => 'form-control','placeholder'=>'Введите версию firmware','maxlength'=>'10'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('conn_fw',old('conn_fw'),['class' => 'form-control','placeholder'=>'Введите версию conn-firmware','maxlength'=>'10'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::select('is_active',['1' => 'Активный', '0' => 'Не активный'], old('is_active'), ['class' => 'form-control','required'=>'required','id'=>'is_active']); !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::select('mode',['0' => 'Норма', '1' => 'Блокировка', '2' => 'Свободный проход', '3' => 'Ожидание свободного прохода', '12' => 'Не установлен'], old('mode'), ['class' => 'form-control','required'=>'required','id'=>'mode']); !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('address',old('address'),['class' => 'form-control','placeholder'=>'Введите IP-адрес устройства','maxlength'=>'15','required'=>'required'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('text',old('text'),['class' => 'form-control','placeholder'=>'Введите описание устройства','maxlength'=>'254'])!!}
