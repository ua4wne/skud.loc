...
@section('content')
    ...
    <div class="x_panel">
        ...
        {!! Form::open(['url' => route('cardEdit',['id'=>$data['id']]),'class'=>'form-horizontal','method'=>'POST','id'=>'new_form']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('code',$data['code'],['class' => 'form-control','disabled'=>'disabled','maxlength'=>'20','required'=>'required'])!!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::select('share',['0' => 'Гостевая', '1' => 'Индивидуальная'], $data['share'], ['class' => 'form-control','required'=>'required','id'=>'share']); !!}
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::select('granted',['1' => 'Активная', '0' => 'Заблокирована'], $data['granted'], ['class' => 'form-control','required'=>'required','id'=>'granted']); !!}
            </div>
        </div>
