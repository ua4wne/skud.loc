...
@section('content')
    ...
    <div class="x_panel">
        ...
        {!! Form::open(['url' => route('actionAdd'),'class'=>'form-horizontal','method'=>'POST','id'=>'new_form']) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('code',old('code'),['class' => 'form-control','placeholder'=>'Введите символьный код','maxlength'=>'70','required'=>'required'])!!}
        ...
        <div class="form-group">
            ...
            <div class="col-xs-8">
                {!! Form::text('name',old('name'),['class' => 'form-control','placeholder'=>'Введите наименование роли','maxlength'=>'100','required'=>'required'])!!}
