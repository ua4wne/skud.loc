                    ...
                    @foreach($rows as $row)
                        ...
                        <tr>
                            ...
                            <td style="width:110px;">
                                {!! Form::open(['url'=>route('evtypeEdit',['id'=>$row->id]), 'class'=>'form-horizontal','method' => 'POST', 'onsubmit' => 'return confirmDelete()']) !!}
                                {{ method_field('DELETE') }}
                                <div class="form-group" role="group">
                                    <a href="{{ route('evtypeEdit',['id'=>$row->id]) }}" class="btn btn-success btn-sm" type="button" title = "Редактировать запись"><i class="fa fa-edit fa-lg" aria-hidden="true"></i></a>
